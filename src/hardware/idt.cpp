...
Spark::Idt::InterruptHandler interrupt_handlers[256] = {};
...
extern "C" void isr_handler(Spark::Idt::InterruptRegisters* registers) {
    uint8_t n = registers->int_num & 0xFF;
    Spark::Idt::InterruptHandler& handler = interrupt_handlers[n];
...
void Spark::Idt::register_interrupt_handler(uint16_t n, idt_function function, bool is_irq, bool should_iret) {
